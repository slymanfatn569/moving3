...
export default function ContactPage() {
  ...
  return (
    <Layout
      title="اتصل بنا | فخر الخليج - مزود الأزياء الرسمية"
      description="تواصل مع فخر الخليج للحصول على حلول الأزياء الرسمية المهنية في جميع أنحاء المملكة العربية السعودية. اطلب استشارة لقطاعات الرعاية الصحية والضيافة والطيران والقطاع الحكومي."
      keywords="اتصال، استشارة الأزياء الرسمية، خدمات الأزياء السعودية، الملابس المهنية، طلب عرض سعر"
    >
      <Head>
        <script
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="corporate">الشركات</option>
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                  >
                    <option value="consultation">استشارة نقل العفش</option>
                    <option value="moving">خدمات نقل العفش</option>
                    <option value="corporate">نقل المكاتب والشركات</option>
                    <option value="cleaning">خدمات التنظيف المتخصصة</option>
